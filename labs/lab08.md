...
Download [CS201\_Lab08\_Gradle.zip](CS201_Lab08_Gradle.zip). Copy and extract the zip file into your **CS201-Fall2026** directory. Import it into your **CS201-Fall2026** IntelliJ project using

> **Open**

Select the **CS201\_Lab08\_Gradle** directory and click **Select Folder**.
